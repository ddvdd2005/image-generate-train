...
# Load a model
model = YOLO("./runs/detect/train7/weights/epoch27.pt")  # pretrained YOLOv8n model
file = cv2.imread("./infer/buoy2.png", cv2.IMREAD_UNCHANGED)
width = file.shape[1]
height = file.shape[0]
...
results = model([expanded_image])  # return a list of Results objects
